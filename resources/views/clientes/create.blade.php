            ...
            <x-card>
                <form method="POST" action="{{ route('clientes.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="telefono" class="block mt-1 w-full" type="text" name="telefono" :value="old('telefono')" placeholder="Ej: 0981-123456" />
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="direccion" name="direccion" rows="3"
                                  ...
                                  placeholder="Ej: Av. España 123, Asunción">{{ old('direccion') }}</textarea>
